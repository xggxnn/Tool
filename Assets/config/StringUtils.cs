...
public static class StringUtils
{
    ...
    public static List<int> ToInt32List(this string src, char separator = ',')
    {
        ...
        foreach(string item in strArr)
        {
            ...
            if(!string.IsNullOrEmpty(str))
            {
                ...
                {
					Debug.LogWarningFormat("src={0}, str={1}, e={2}", src, str, e);
                }
            }
        }
        return list;
    ...
    //先临时加在这里(官方建议UnityEngine.Object 在lua里头不要用obj == nil来判断，而是用那个扩展方法obj:IsNull())//
    public static bool IsUnityEngineObjectNull(this UnityEngine.Object self)
    {
        return self == null;
    }
